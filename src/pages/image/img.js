const yinshuaji = require("../../img/yinshuaji.png");
const yinshuajicanshu = require("../../img/yinshuajicanshu.png");
const jianceshebei_spi_3d = require("../../img/jianceshebei-spi.jpeg");
const jianceshebeicanshu_spi_3d = require("../../img/jianceshebeicanshu-spi.png");
const jianceshebei = require("../../img/jianceshebei.png");
const tiepianji = require("../../img/tiepianji.png");
const tiepianjicanshu = require("../../img/tiepianjicanshu.png");
const jianceshebei_aoi_3d = require("../../img/jianceshebei-aoi-3d.png");
const jianceshebeicanshu_aoi_3d = require("../../img/jianceshebeicanshu-aoi-3d.png");
const jianceshebei_1 = require("../../img/jianceshebei-1.png");
const jianceshebeicanshu_1 = require("../../img/jianceshebeicanshu-1.png");
const jianceshebei_gex_ray = require("../../img/jianceshebei-gex-ray.png");
const jianceshebeicanshu_gex_ray = require("../../img/jianceshebeicanshu-gex-ray.png");
const huiliuhan = require("../../img/huiliuhan.png");
const huiliuhancanshu = require("../../img/huiliuhancanshu.png");
const huiliuhan_danqi = require("../../img/huiliuhan-danqi.png");
const huiliuhancanshu_danqi = require("../../img/huiliuhancanshu-danqi.png");
const bofenghan = require("../../img/bofenghan.png");
const bofenghancanshu = require("../../img/bofenghancanshu.png");
const bofenghan_1 = require("../../img/bofenghan-1.png");
const bofenghancanshu_1 = require("../../img/bofenghancanshu-1.png");
const bofenghan_xuanzexing = require("../../img/bofenghan-xuanzexing.png");
const bofenghancanshu_xuanzexing = require("../../img/bofenghancanshu-xuanzexing.png");
const sanfangtufushebei = require("../../img/sanfangtufushebei.jpeg");
const sanfangtufushebeicanshu = require("../../img/sanfangtufushebeicanshu.png");
const weixiushebei = require("../../img/weixiucanshu.png");
const weixiushebeicanshu = require("../../img/weixiushebeicanshu.png");
const fuzhushebei = require("../../img/fuzhushebei.png");
const fuzhushebeicanshu = require("../../img/fuzhushebeicanshu.png");
const fuzhushebei_1 = require("../../img/fuzhushebei-1.png");
const fuzhushebeicanshu_1 = require("../../img/fuzhushebeicanshu-1.png");
//前台
...
const chanxian_1 = require("../../img/chanxian_1.jpg");
const chanxian_2 = require("../../img/chanxian_2.jpg");
...
export default {
  ...
  jianceshebei,
  jianceshebei_spi_3d,
  jianceshebeicanshu_spi_3d,
  tiepianji,
  tiepianjicanshu,
  jianceshebei_aoi_3d,
  jianceshebeicanshu_aoi_3d,
  jianceshebei_1,
  jianceshebeicanshu_1,
  jianceshebei_gex_ray,
  jianceshebeicanshu_gex_ray,
  huiliuhan,
  huiliuhancanshu,
  huiliuhan_danqi,
  huiliuhancanshu_danqi,
  bofenghan,
  bofenghancanshu,
  bofenghan_1,
  bofenghancanshu_1,
  bofenghan_xuanzexing,
  bofenghancanshu_xuanzexing,
  sanfangtufushebei,
  sanfangtufushebeicanshu,
  weixiushebei,
  weixiushebeicanshu,
  fuzhushebei,
  fuzhushebeicanshu,
